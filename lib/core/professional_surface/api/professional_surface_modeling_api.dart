  ...
  Future<ProfessionalSurfaceDefinition> editNurbs(
    ...
    return edit(
      ...
      parameters: {
        ...current.parameters,
        if (controlPoints != null) 'controlPoints': controlPoints,
        if (insertKnotsU != null) 'insertKnotsU': insertKnotsU,
        if (insertKnotsV != null) 'insertKnotsV': insertKnotsV,
        if (removeKnotsU != null) 'removeKnotsU': removeKnotsU,
        if (removeKnotsV != null) 'removeKnotsV': removeKnotsV,
        if (degreeU != null) 'degreeU': degreeU,
        if (degreeV != null) 'degreeV': degreeV,
        'refine': refine,
        'rebuild': rebuild,
      },
    );
